...
public class ArbolExpresionGrafico extends JPanel 
{
    ...
    private void calcularPosiciones() 
    {
         posicionNodos.clear();
         subtreeSizes.clear();
         NodoABB root = this.miArbol.getRaiz();
         if (root != null) 
         {
     ...
     */
    private Dimension calcularTamañoSubarbol(NodoABB n) 
    {
          if (n == null) 
     ...
     */
    private void dibujarArbol(Graphics2D g, NodoABB n, int puntox, int puntoy, int yoffs) 
    {
     if (n == null) 
         return;
